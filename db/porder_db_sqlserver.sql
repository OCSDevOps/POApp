-- =============================================
-- POAPP Database Schema for SQL Server Express
-- Converted from MySQL to SQL Server format
-- =============================================

-- Create database if not exists
IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = N'porder_db')
BEGIN
    CREATE DATABASE porder_db;
END
GO
...
-- =============================================
IF OBJECT_ID('dbo.user_views', 'V') IS NOT NULL DROP VIEW dbo.user_views;
...
IF OBJECT_ID('dbo.unit_of_measure_tab', 'U') IS NOT NULL DROP TABLE dbo.unit_of_measure_tab;
IF OBJECT_ID('dbo.taxcode_master', 'U') IS NOT NULL DROP TABLE dbo.taxcode_master;
IF OBJECT_ID('dbo.taxgroup_master', 'U') IS NOT NULL DROP TABLE dbo.taxgroup_master;
IF OBJECT_ID('dbo.supplier_catalog_tab', 'U') IS NOT NULL DROP TABLE dbo.supplier_catalog_tab;
IF OBJECT_ID('dbo.supplier_master', 'U') IS NOT NULL DROP TABLE dbo.supplier_master;
IF OBJECT_ID('dbo.receive_order_details', 'U') IS NOT NULL DROP TABLE dbo.receive_order_details;
IF OBJECT_ID('dbo.receive_order_master', 'U') IS NOT NULL DROP TABLE dbo.receive_order_master;
IF OBJECT_ID('dbo.purchase_order_details', 'U') IS NOT NULL DROP TABLE dbo.purchase_order_details;
IF OBJECT_ID('dbo.purchase_order_master', 'U') IS NOT NULL DROP TABLE dbo.purchase_order_master;
IF OBJECT_ID('dbo.project_details', 'U') IS NOT NULL DROP TABLE dbo.project_details;
IF OBJECT_ID('dbo.project_master', 'U') IS NOT NULL DROP TABLE dbo.project_master;
IF OBJECT_ID('dbo.master_user_type', 'U') IS NOT NULL DROP TABLE dbo.master_user_type;
IF OBJECT_ID('dbo.item_package_details', 'U') IS NOT NULL DROP TABLE dbo.item_package_details;
IF OBJECT_ID('dbo.item_package_master', 'U') IS NOT NULL DROP TABLE dbo.item_package_master;
IF OBJECT_ID('dbo.item_master', 'U') IS NOT NULL DROP TABLE dbo.item_master;
IF OBJECT_ID('dbo.item_category_tab', 'U') IS NOT NULL DROP TABLE dbo.item_category_tab;
IF OBJECT_ID('dbo.cost_code_master', 'U') IS NOT NULL DROP TABLE dbo.cost_code_master;
IF OBJECT_ID('dbo.company_tab', 'U') IS NOT NULL DROP TABLE dbo.company_tab;
GO
...
CREATE TABLE cost_code_master (
    cc_id BIGINT IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE item_category_tab (
    icat_id INT IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE item_package_details (
    ipdetail_id BIGINT IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE item_package_master (
    ipack_id BIGINT IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE master_user_type (
    mu_id INT IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE project_details (
    pdetail_id BIGINT IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE project_master (
    proj_id BIGINT IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE purchase_order_master (
    porder_id BIGINT IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE receive_order_details (
    ro_detail_id BIGINT IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE receive_order_master (
    rorder_id BIGINT IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE supplier_catalog_tab (
    supcat_id BIGINT IDENTITY(1,1) PRIMARY KEY,
    ...
    supcat_modifyby BIGINT NOT NULL,
...
CREATE TABLE supplier_master (
    sup_id BIGINT IDENTITY(1,1) PRIMARY KEY,
...
CREATE TABLE user_info (
    ...
    status CHAR(1) NOT NULL DEFAULT '1' -- '0' or '1'
);
GO
...
CREATE TABLE user_details (
    ...
    CONSTRAINT FK_user_details_user_info FOREIGN KEY (uid) REFERENCES user_info(u_id) ON DELETE CASCADE ON UPDATE CASCADE
);
GO
...
SELECT 
    ...
    mut.mu_name
FROM user_info ui
INNER JOIN user_details ud ON ui.u_id = ud.uid
INNER JOIN master_user_type mut ON ui.u_type = mut.mu_id;
GO
...
-- company_tab
SET IDENTITY_INSERT company_tab ON;
...
SET IDENTITY_INSERT company_tab OFF;
GO

-- cost_code_master
SET IDENTITY_INSERT cost_code_master ON;
...
SET IDENTITY_INSERT cost_code_master OFF;
GO

-- item_category_tab
SET IDENTITY_INSERT item_category_tab ON;
...
SET IDENTITY_INSERT item_category_tab OFF;
GO

-- item_master
SET IDENTITY_INSERT item_master ON;
...
SET IDENTITY_INSERT item_package_details ON;
...
SET IDENTITY_INSERT item_package_details OFF;
GO

-- item_package_master
SET IDENTITY_INSERT item_package_master ON;
...
SET IDENTITY_INSERT item_package_master OFF;
GO

-- master_user_type
SET IDENTITY_INSERT master_user_type ON;
...
SET IDENTITY_INSERT master_user_type OFF;
GO

-- project_details
SET IDENTITY_INSERT project_details ON;
...
SET IDENTITY_INSERT project_details OFF;
GO

-- project_master
SET IDENTITY_INSERT project_master ON;
...
SET IDENTITY_INSERT project_master OFF;
GO
...
SET IDENTITY_INSERT purchase_order_master ON;
INSERT INTO purchase_order_master (porder_id, porder_project_ms, porder_no, porder_supplier_ms, porder_address, porder_delivery_note, porder_total_item, porder_total_amount, porder_delivery_status, porder_createdate, porder_createby, porder_modifydate, porder_modifyby, porder_status, porder_total_tax) VALUES
...
SET IDENTITY_INSERT purchase_order_master OFF;
GO

-- receive_order_details
SET IDENTITY_INSERT receive_order_details ON;
...
SET IDENTITY_INSERT receive_order_details OFF;
GO

-- receive_order_master
SET IDENTITY_INSERT receive_order_master ON;
...
SET IDENTITY_INSERT receive_order_master OFF;
GO

-- supplier_catalog_tab
SET IDENTITY_INSERT supplier_catalog_tab ON;
...
(1, 2, 'U001', 'S3423', 1, 3.44, '2022-04-02', NULL, '2022-04-21 19:26:09', 1, '2022-01-01 00:00:00', 0, 1),
(2, 2, 'U001', 'S341111', 2, 4.22, '2022-04-15', NULL, '2022-04-21 19:48:31', 1, '2022-04-23 07:13:50', 1, 1),
(3, 1, 'A998', 'SADFFF', 1, 33.00, '2022-05-10', NULL, '2022-05-01 15:14:43', 1, '2022-01-01 00:00:00', 0, 1),
(4, 2, 'ITM003', 'SA', 3, 232.00, '2022-05-30', NULL, '2022-05-01 15:17:40', 1, '2022-01-01 00:00:00', 0, 1),
(5, 2, 'ITM003', 'PPP', 1, 666.00, '2022-05-27', NULL, '2022-05-01 15:19:29', 1, '2022-01-01 00:00:00', 0, 1),
(6, 2, 'B3242', 'TT', 2, 33.00, '2022-05-11', NULL, '2022-05-01 15:29:24', 1, '2022-01-01 00:00:00', 0, 1);
SET IDENTITY_INSERT supplier_catalog_tab OFF;
GO

-- supplier_master
SET IDENTITY_INSERT supplier_master ON;
...
SET IDENTITY_INSERT supplier_master OFF;
GO

-- taxcode_master
SET IDENTITY_INSERT taxcode_master ON;
INSERT INTO taxcode_master (tc_id, tc_tax_value, tc_createdate, tc_status) VALUES
(1, 10.00, '2022-04-26 00:00:00', 1);
SET IDENTITY_INSERT taxcode_master OFF;
GO

-- unit_of_measure_tab
SET IDENTITY_INSERT unit_of_measure_tab ON;
...
SET IDENTITY_INSERT unit_of_measure_tab OFF;
GO
...
PRINT 'Database porder_db created and populated successfully!';
GO
