                            ...
                            <?php echo form_open_multipart('','class="form-horizontal" id="myForm"'); ?>
							    <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="pr_no" id="pr_no" placeholder="Enter Project Number" autocomplete="off" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="pr_name" id="pr_name" placeholder="Enter Project Name" autocomplete="off" />
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea class="form-control" name="pr_address" id="pr_address" placeholder="Enter Full Address" autocomplete="off"></textarea>
									...
									<div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea class="form-control" name="pr_desc" id="pr_desc" placeholder="Enter Description" autocomplete="off"></textarea>
