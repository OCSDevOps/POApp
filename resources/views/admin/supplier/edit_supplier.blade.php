...
@section('title', 'Edit Supplier - ' . $supplier->sup_name)
...
<div class="container-fluid">
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="{{ route('admin.suppliers.update', $supplier->sup_id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" name="sup_email" id="sup_email"
                               ...
                               value="{{ old('sup_email', $supplier->sup_email) }}" required>
                        @error('sup_email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="sup_phone" id="sup_phone"
                               ...
                               value="{{ old('sup_phone', $supplier->sup_phone) }}" required>
                        @error('sup_phone')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="sup_contact_person" id="sup_contact_person"
                               ...
                               value="{{ old('sup_contact_person', $supplier->sup_contact_person) }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="sup_type" id="sup_type" class="form-select @error('sup_type') is-invalid @enderror">
                            <option value="1" {{ old('sup_type', $supplier->sup_type) == 1 ? 'selected' : '' }}>Supplier</option>
                            <option value="2" {{ old('sup_type', $supplier->sup_type) == 2 ? 'selected' : '' }}>Subcontractor</option>
                            <option value="3" {{ old('sup_type', $supplier->sup_type) == 3 ? 'selected' : '' }}>Both</option>
                        </select>
                        @error('sup_type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="sup_address" id="sup_address"
                               ...
                               value="{{ old('sup_address', $supplier->sup_address) }}" required>
                        @error('sup_address')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="sup_details" id="sup_details" rows="3"
                               class="form-control @error('sup_details') is-invalid @enderror">{{ old('sup_details', $supplier->sup_details) }}</textarea>
                        @error('sup_details')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
