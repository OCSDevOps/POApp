            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Modify Package</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url('admincontrol/dashboard'); ?>">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Modify Package</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <?php echo form_open_multipart('','class="form-horizontal" id="myForm"'); ?>
                                ...
                                <div class="border-top">
                                    <div class="card-body">
										...
										<!--&nbsp;<a href="<?= site_url('admincontrol/projects/all_project_list') ?>" class="btn btn-danger">Back</a>-->
                                    </div>
                                </div>
                            <?php form_close(); ?>
                        </div>
