			...
			<div class="modal-content">
				...
				<div class="modal-body">
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Enter Supplier Name" name="name_supp" id="name_supp" autocomplete="off" />
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Enter Contact Person Name" name="name_supp_cp" id="name_supp_cp" autocomplete="off" />
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Enter Contact Mobile" name="supp_phone" id="supp_phone" autocomplete="off" />
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="Enter Contact Email" name="supp_email" id="supp_email" autocomplete="off" />
						...
						<div class="form-group">
							...
							<textarea class="form-control" placeholder="Enter Address" id="supp_address" name="supp_address" autocomplete="off"></textarea>
