	...
	<div class="page-breadcrumb">
		<div class="row">
			<div class="col-12 d-flex no-block align-items-center">
				<h4 class="page-title">Add New Purchase Order</h4>
						...
						<div class="form-group row justify-content-md-center">
							<div class="col-sm-12">
								<div class="table-responsive">
									<table style="width:100%!important" class="table table-bordered" id="porder_table">
										<thead>
										<tr>
										...
										<tr data-id="1" style="width:100%">
											<td>
												...
												<small class="invalid-feedback pk_item1_error"><?php echo form_error('pk_item1'); ?></small>
											</td>
											<td>
												...
												<small
														class="invalid-feedback pk_desc1_error"><?php echo form_error('pk_desc1'); ?></small>
											</td>
											<td>
												<select class="form-control select2 custom-select pk_ccode po_item_required_select"
														name="pk_ccode[]" id="pk_ccode1"
														data-container='body'
														data-width="110px"
														data-live-search="true" autocomplete="off" data-id="1">
													<option value="">---Select---</option>
												...
												<small class="invalid-feedback pk_ccode1_error"><?php echo form_error('pk_ccode1'); ?></small>
											</td>

											<td>
												<select class="form-control select2 custom-select pk_uom po_item_required_select"
														name="pk_uom[]" id="pk_uom1"
														data-container='body'
														data-width="80px"
														data-live-search="true" autocomplete="off" data-id="1">
													<option value="">---Select---</option>
												...
												<small class="invalid-feedback pk_uom1_error"><?php echo form_error('pk_uom1'); ?></small>
											</td>
											<td>
												<input type="number" class="form-control pk_itm_qnty po_item_required"
													   name="pk_itm_qnty[]"
													   id="pk_itm_qnty1" placeholder="Qty" autocomplete="off"
													   onchange="goto_check_item_amounts(this);" data-id="1"/>
												<small
														class="invalid-feedback pk_itm_qnty1_error"><?php echo form_error('pk_itm_qnty1'); ?></small>
											</td>
											<td>
												...
												<input type="hidden" class="form-control pk_subtotal"
													   ...
													   readonly/>
												<input type="hidden" class="form-control pk_tax"
													   name="pk_tax[]"
													   id="pk_tax" autocomplete="off"
													   readonly/>
												<input type="number" class="form-control pk_itm_price po_item_required"
													   name="pk_itm_price[]"
														data-width="80px"
													   id="pk_itm_price1" placeholder="Price" data-id="1"
													   autocomplete="off"
													   onchange="goto_check_item_amounts(this);"/>
												<small
														class="invalid-feedback pk_itm_price1_error"><?php echo form_error('pk_itm_price1'); ?></small>
											</td>

											<td>
												<select class="form-control select2 custom-select pk_tax_group po_item_required_select"
												...
												<small class="invalid-feedback pk_tax_group1_error"><?php echo form_error('pk_tax_group1'); ?></small>
											</td>
											<td>
												<input type="text" class="form-control pre_tax_amt" name="pre_tax_amt[]"
													   id="pre_tax_amt1" placeholder="Pre-Tax Amount" autocomplete="off"
													   readonly/>
												<small
											...
											<td>
												<input type="text" class="form-control pk_tax_amt" name="pk_tax_amt[]"
													   id="pk_tax_amt1" placeholder="Item Tax Amount" autocomplete="off"
													   readonly/>
												<small
...
//form_data.append("files", files[0]);
		...
		jQuery(document).delegate('a.add_row', 'click', function (e) {
			...
			var content = '<tr data-id="' + size + '">\n' +
					'\t\t\t\t<td>\n' +
					'\t\t\t\t\t<select class="form-control select2 custom-select po_item_required_select pk_item" data-id="' + size + '" id="pk_item' + size + '" name="pk_item[]"\n' +
					'\t\t\t\t\t\t\tdata-live-search="true" data-width="110px" data-container="body" autocomplete="off"\n' +
					'\t\t\t\t\t\t\tonchange="goto_check_item(this);">\n' +
					'\t\t\t\t\t\t<option value="">---Select---</option>\n' +
					'\t\t\t\t\t\t<?php foreach ($itm_list as $items) { ?>\n' +
					...
					'\t\t\t\t\t\t\t\t\t\t\t\t\t\t  data-container="body" data-width="110px" name="pk_ccode[]"\n' +
					'\t\t\t\t\t\t\t\t\t\t\t\t\t\ id="pk_ccode' + size + '"\n' +
					'\t\t\t\t\t\t\t\t\t\t\t\t\t\t data-live-search="true" autocomplete="off" data-id="' + size + '">\n' +
					'\t\t\t\t\t\t\t\t\t\t\t\t\t<option value="">---Select---</option>\n' +
					'\t\t\t\t\t\t\t\t\t\t\t\t\t<?php foreach ($ccode_list as $items) { ?>\n' +
					'\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value="<?php echo $items->cc_id; ?>"><?php echo $items->cc_no.' - '.$items->cc_description; ?></option>\n' +
					'\t\t\t\t\t\t\t\t\t\t\t\t\t<?php } ?>\n' +
					...
					'\t\t\t\t\t\t\t\t\t\t\t\t\t\tname="pk_uom[]" data-container="body" id="pk_uom' + size + '"\n' +
					'\t\t\t\t\t\t\t\t\t\t\t\t\t\tdata-live-search="true" data-width="80px" autocomplete="off" data-id="' + size + '">\n' +
					'\t\t\t\t\t\t\t\t\t\t\t\t\t<option value="">---Select---</option>\n' +
					'\t\t\t\t\t\t\t\t\t\t\t\t\t<?php foreach ($uom_list as $items) { ?>\n' +
					'\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value="<?php echo $items->uom_id; ?>"><?php echo $items->uom_name; ?></option>\n' +
					'\t\t\t\t\t\t\t\t\t\t\t\t\t<?php } ?>\n' +
					...
					'\t\t\t\t</td>\n' +
					'\t\t\t\t<td>\n' +
					'\t\t\t\t\t<select class="form-control select2 custom-select pk_tax_group po_item_required_select po_item_required"\n' +
					'\t\t\t\t\t\t\tdata-live-search="true" data-container="body" id="pk_tax_group' + size + '" data-id="' + size + '" autocomplete="off" name="pk_tax_group[]"\n' +
					'\t\t\t\t\t\t\tid="pk_tax_group" data-width="80px" onchange="goto_addTax(this);">\n' +
					'\t\t\t\t\t\t<option value="">---Select---</option>\n' +
					'\t\t\t\t\t\t<?php foreach ($taxgroup_list as $items) { ?>\n' +
					...
					success: function (data) {
						...
						if (data.msg == 1) {
							...
							for (ii = 0; ii < data.s_msg.length; ii++) {
								mixstring = mixstring + '<tr><td>' + data.s_msg[ii].item_name + '</td><td>' + data.s_msg[ii].ipdetail_item_ms + '</td><td><input type="hidden" name="ipackitem_code_' + ii + '" class="ipackitem_code" id="ipackitem_code_' + ii + '" value="' + data.s_msg[ii].ipdetail_item_ms + '" /><input type="text" name="ipackitem_qty_' + ii + '" id="ipackitem_qty_' + ii + '" value="' + data.s_msg[ii].ipdetail_quantity + '" /></td></tr>';
							}
					...
					success: function (data) {
						...
						if (data.msg == 1) {
							...
							data.s_msg.forEach(function (item) {
								...
								var content = '<tr data-id="' + size + '">\n' +
										'\t\t\t\t<td>\n' +
										'\t\t\t\t\t<select class="form-control select2 custom-select po_item_required_select po_item_required pk_item" id="pk_item' + size + '" readonly data-id="' + size + '" name="pk_item[]"\n' +
										'\t\t\t\t\t\t\tdata-live-search="true" data-width="110px" data-container="body" autocomplete="off"\n' +
										'\t\t\t\t\t\t\tonchange="goto_check_item(this);">\n' +
										'\t\t\t\t\t\t<option value="">---Select---</option>\n' +
										'\t\t\t\t\t\t<?php foreach ($itm_list as $items) { ?>\n' +
										...
										'\t\t\t\t<td>\n' +
										'<select class="form-control select2 custom-select pk_uom po_item_required_select po_item_required"\n' +
										'\t\t\t\t\t\t\t\t\t\t\t\t\t\tname="pk_uom[]" data-width="80px" data-container="body" id="pk_uom' + size + '"\n' +
										'\t\t\t\t\t\t\t\t\t\t\t\t\t\tdata-live-search="true" autocomplete="off" data-id="'+ size +'">\n' +
										'\t\t\t\t\t\t\t\t\t\t\t\t\t<option value="">---Select---</option>\n' +
										'\t\t\t\t\t\t\t\t\t\t\t\t\t<?php foreach ($uom_list as $items) { ?>\n' +
										'\t\t\t\t\t\t\t\t\t\t\t\t\t\t<option value="<?php echo $items->uom_id; ?>"><?php echo $items->uom_name; ?></option>\n' +
										...
										'\t\t\t\t\t\t   id="pk_itm_qnty' + size + '" placeholder="Enter Quantity" data-id="' + size + '" autocomplete="off"\n' +
										'\t\t\t\t\t\t   onchange="goto_check_item_amounts(this);"/>\n' +
										'\t\t\t\t\t<small class="invalid-feedback pk_itm_qnty' + size + '_error' + size + '_error"><?php echo form_error("pk_itm_qnty"); ?></small>\n' +
										'\t\t\t\t</td>\n' +
										'\t\t\t\t<td>\n' +
								...
								$('#porder_table_body').append(content);
								$('#porder_table_body tr[data-id=' + size + ']').find('select[name="pk_item[]"] option[value=' + item.po_detail_item + ']').attr('selected', 'selected').change();
...
//var ap_quaran = $("input[name='ap_quaran']:checked").val();
			...
			$('.po_item_required,.po_item_required_select select,.po_item_required_select').each(function(){
				var id=$(this).attr('id');
			...
			if (e_error == 1) {
				...
				form_data.append("po_type", 'Material PO');
				form_data.append("po_status", status);

				var poTableLength = $('#porder_table >tbody >tr').length;
				var overageCount=0;
				...
				if(projectName!='Sandbox Test Project'){
					...
					// alert(JSON.stringify(ccArray2));

					var ccError='';
					if(balance<0){
					if(poCostCodesArray[j] in revisedCostArray){}else{
						ccError='<div style="text-align:center"><span class="text-danger">( Cost Code not associated with the selected project )</span></div>'
					}
					$('#po_summary_table >tbody').append('\
						...
						<tr>\
							...
							<td style="font-weight:bold;vertical-align:middle">Revised Budget ( '+revisedCost+' ) - ( Committed Cost ( '+committedCost+' ) + Total New Committed Cost ( '+totalItemsCost+' ) ) <br> '+ccError+'</td>\
				...
				if(overageCount>0){
					...
					// alert(JSON.stringify(committedCostArray));
...
//$("#myForm").submit();
		...
		$('#po_project').change(function(){
			getProjectBudget($(this).val());
		});
			...
			$('#item_package_table >tbody >tr').each(function(){
				// if($(this).is(':checked')){
					if(itemCount==1 && $('#pk_item1').val()==''){
						...
						$('#pk_item'+size).val($('#ipackitem_code_'+itemCount1).val()).change();
						$('#pk_itm_qnty'+size).val($('#ipackitem_qty_'+itemCount1).val());
						$('body input[name="pk_itm_price[]"]').trigger('change');
						$('.select2').selectpicker('refresh');
						itemCount++;
						itemCount1++;
					}
