            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Rental Order List</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url('admincontrol/dashboard'); ?>">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Rental Order List</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
								...
								<form action="" method="get" enctype="multipart/form-data">
									<div class="row">
										...
										<div class="col-sm-2">
											...
											<button type="button" onclick="window.location.href='<?php echo base_url("admincontrol/rorder/all_rental_order_list"); ?>'" class="btn btn-success">Reset</button>
										</div>
									</div>
								</form>
                    ...
                    <div class="col-12">
						<div class="card">
                            <div class="card-body">
								...
								<?php 
								if($this->session->userdata('utype')==1 || $templateDetails->pt_t_rorder<3){?>
                                	<a href="<?php echo base_url().'admincontrol/rorder/add_new_rental_order'; ?>" class="btn btn-primary float-right mb-2" style="margin-right: 10px;">Add New Rental Order</a>
								<?php }?>
...
<!--											<td>-->
											...
											<td><?php $status = "Not Received";
												...
												?></td>
											<td>
												<a class="btn btn-outline-warning" href="<?php echo base_url().'admincontrol/rorder/modify_rorder_sets/'.$recorditem->porder_id.'/1'; ?>" title="View Record"><i class="fa fa-eye text-primary"></i></a>
													<?php 
													if($this->session->userdata('utype')==1 || $templateDetails->pt_t_rorder<3){?>
														<?php if($recorditem->porder_general_status != 'submitted') { ?>
														<a class="btn btn-outline-warning" href="<?php echo base_url().'admincontrol/rorder/modify_rorder_sets/'.$recorditem->porder_id.'/0'; ?>" title="Edit Record"><i class="fa fa-edit text-primary"></i></a>
														<?php } ?>
														<a class="btn btn-outline-warning" onclick="return confirm('You are about to delete a record. This cannot be undone. Are you sure?');" href="<?php echo base_url().'admincontrol/rorder/delete_itemset/'.$recorditem->porder_id; ?>" title="Delete Record"><i class="fa fa-trash text-danger"></i></a>
													<?php }?>
												</td>
										</tr>	
										<?php } ?>
	...
	<div class="modal fade" id="Modal_editrecord" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true" data-backdrop="static" data-keyboard="false">
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Modify  Recieve Order Details</h5>
