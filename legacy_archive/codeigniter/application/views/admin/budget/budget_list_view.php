                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
										<?php foreach($getbudget_list as $keys=>$recorditem)
										{ ?>
										<tr>
											...
											<td><?php echo $recorditem->cost_code.'-'.$recorditem->cost_code_name; ?></td>
											<td>
												<?php 
											...
											<td>
												<?php 
													echo $formatter->formatCurrency($recorditem->revised_budget, 'USD'); 
												?>
											</td>
											<td>
												<?php 
													echo $formatter->formatCurrency($recorditem->committed_cost, 'USD'); 
												?>
											</td>
										</tr>	
										<?php } ?>
